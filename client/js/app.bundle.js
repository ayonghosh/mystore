...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppView = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListPageView = __webpack_require__(6);
	var CartView = __webpack_require__(8);
	var LoginView = __webpack_require__(10);
	var CheckoutView = __webpack_require__(12);
	var CheckoutStatusView = __webpack_require__(14);
	var CartModel = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListPageTemplate = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CartViewPage = __webpack_require__(9);
...
/***/ function(module, exports) {
	...
	module.exports = "<section id=\"cart-page\">\r\n\t<div class=\"title\">\r\n\t\tYour Shopping Cart\r\n\t</div>\r\n\t<% if (items.length === 0) { %>\r\n\t\t<div class=\"cart-contents\">\r\n\t\t\tNo items have been added.\r\n\t\t\t<div>\r\n\t\t\t\t<a href=\"#/list\" class=\"continue-btn\">Continue Shopping</a>\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t<% } else { %>\r\n\t\t<div class=\"cart-contents\">\r\n\t\t\t<table>\r\n\t\t\t\t<thead>\r\n\t\t\t\t\t<th>Item</th>\r\n\t\t\t\t\t<th></th>\r\n\t\t\t\t\t<th>Price</th>\r\n\t\t\t\t\t<th>Quantity</th>\r\n\t\t\t\t\t<th>Total</th>\r\n\t\t\t\t\t<th></th>\r\n\t\t\t\t</thead>\r\n\t\t\t\t<tbody>\r\n\t\t\t\t\t<% var totalPrice = 0 %>\r\n\t\t\t\t\t<% _.each(items, function (item) { %>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t\t<div class=\"image <%= item.imageClass %>\"></div>\r\n\t\t\t\t\t\t\t</td> \r\n\t\t\t\t\t\t\t<td class=\"desc\">\r\n\t\t\t\t\t\t\t\t<div class=\"item-title\"><%= item.title %></div>\r\n\t\t\t\t\t\t\t\t<div class=\"subtitle\"><%= item.desc %></div>\r\n\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t<td class=\"price\">INR <%= item.price %></td>\r\n\t\t\t\t\t\t\t<td class=\"quantity\">\r\n\t\t\t\t\t\t\t\t<input type=\"number\" name=\"quantity\" min=\"1\" max=\"10\" step=\"1\" value=\"<%= item.quantity %>\" data-id=\"<%= item.id %>\">\r\n\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t<td class=\"total\">INR <%= item.price * item.quantity %></td>\r\n\t\t\t\t\t\t\t<td class=\"remove\">\r\n\t\t\t\t\t\t\t\t<button class=\"delete\" data-id=\"<%= item.id %>\"></button>\r\n\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<% totalPrice += (item.price * item.quantity) %>\r\n\t\t\t\t\t<% }) %>\r\n\t\t\t\t</tbody>\r\n\t\t\t</table>\r\n\t\t</div>\r\n\t\t<div class=\"total-price\">\r\n\t\t\tTotal Price: <%= totalPrice %>\r\n\t\t</div>\r\n\t\t<div class=\"checkout\">\r\n\t\t\t<a href=\"/#checkout\" class=\"checkout-btn\">\r\n\t\t\t\tProceed to Checkout\r\n\t\t\t</a>\r\n\t\t</div>\r\n\t<% } %>\r\n</section>\r\n";
...
/***/ function(module, exports) {
	...
	module.exports = "<section class=\"login\">\r\n\t<% if (isLoggedIn) { %>\r\n\t\t<div>\r\n\t\t\t<button class=\"login-btn logout-action\">Sign Out</button>\r\n\t\t</div>\r\n\t<% } else { %>\r\n\t\t<div>\r\n\t\t\t<label>Username</label>\r\n\t\t\t<input type=\"text\" id=\"username\">\r\n\t\t</div>\r\n\t\t<div>\r\n\t\t\t<label>Password</label>\r\n\t\t\t<input type=\"password\" id=\"password\">\r\n\t\t</div>\r\n\t\t<div>\r\n\t\t\t<button class=\"login-btn login-action\">Sign In</button>\r\n\t\t</div>\r\n\t\t<div class=\"error-msg\"></div>\r\n\t<% } %>\t\r\n</section>\r\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CheckoutPage = __webpack_require__(13);
...
/***/ function(module, exports) {
	...
	module.exports = "<section id=\"checkout-page\">\r\n\t<div class=\"title\">\r\n\t\tCheckout\r\n\t</div>\r\n\t<div class=\"subtitle\">Please select an address:</div>\r\n\t<div class=\"addr-ctr\">\r\n\t\t<% _.each(addresses, function (address) { %>\r\n\t\t\t<div class=\"addr\" data-id=\"<%= address.id %>\">\r\n\t\t\t\t<div>\r\n\t\t\t\t\t<label>Name</label>\r\n\t\t\t\t\t<span><%= address.name %></span>\r\n\t\t\t\t</div>\r\n\t\t\t\t<div>\r\n\t\t\t\t\t<label>Address</label>\r\n\t\t\t\t\t<span><%= address.address %></span>\r\n\t\t\t\t</div>\r\n\t\t\t\t<div>\r\n\t\t\t\t\t<label>City</label>\r\n\t\t\t\t\t<span><%= address.city %></span>\r\n\t\t\t\t</div>\r\n\t\t\t\t<div>\r\n\t\t\t\t\t<label>Zip</label>\r\n\t\t\t\t\t<span><%= address.zip %></span>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t<% }) %>\r\n\t</div>\r\n</section>\r\n";
